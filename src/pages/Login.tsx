...
import { Mail, Lock, ArrowRight, Github, Loader2, Eye, EyeOff, Chrome } from 'lucide-react';
    ...
    <div className="pt-32 pb-24 min-h-screen flex items-center justify-center">
      ...
      >
        <div className="text-center mb-10">
          ...
          <p className="text-secondary/60 dark:text-white/60">Log in to your MukitX account</p>
        </div>
